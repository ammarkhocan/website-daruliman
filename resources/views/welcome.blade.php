    ...
    <div class="row py-5" data-aos="zoom-in">
      <div class="col-lg-4">
        <div class="card border-0">
          <img src="{{ asset('assets/images/il-berita-01.png') }}" class="img-fluid mb-3" alt="Berita 1">
      ...
      <div class="col-lg-4">
        <div class="card border-0">
          <img src="{{ asset('assets/images/il-berita-01.png') }}" class="img-fluid mb-3" alt="Berita 2">
          <div class="konten-berita">
            <p class="mb-3">30/09/2024</p>
            <h4 class="fw-bold mb-3">Pengajian Bulanan Pesantren Darul Iman</h4>
            <p class="text-secondary">#pesantrenmodern</p>
      ...
      <div class="col-lg-4">
        <div class="card border-0">
          <img src="{{ asset('assets/images/il-berita-01.png') }}" class="img-fluid mb-3" alt="Berita 3">
          <div class="konten-berita">
            <p class="mb-3">30/09/2024</p>
            <h4 class="fw-bold mb-3">Pengajian Bulanan Pesantren Darul Iman</h4>
            <p class="text-secondary">#pesantrenmodern</p>
    ...
    <div class="row py-5">
      <div class="col-lg-4" data-aos="zoom-in-up">
        <iframe 
          width="100%" 
          height="215" 
          src="https://www.youtube.com/embed/FKIn3wV8rn0?si=CutsiuwqWwu4Dk5N" 
          title="YouTube video player" 
          frameborder="0" 
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
          referrerpolicy="strict-origin-when-cross-origin" 
